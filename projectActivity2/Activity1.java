...
public class Activity1 {
    ...
    public void testSearchAppium() throws InterruptedException {
        ...
        Thread.sleep(4000);
        driver.findElement(MobileBy.xpath("//android.webkit.WebView/android.view.View[2]/android.view.View[3]/android.view.View[15]/android.view.View")).click();
        Thread.sleep(4000);
        wait.until(ExpectedConditions.presenceOfElementLocated(MobileBy.xpath("//android.webkit.WebView/android.view.View/android.view.View[4]/android.view.View[1]/android.widget.Button")));
